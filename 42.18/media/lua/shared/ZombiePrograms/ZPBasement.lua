...
ZombiePrograms.Basement = {}
ZombiePrograms.Basement.Stages = {}

ZombiePrograms.Basement.Init = function(bandit)
end

ZombiePrograms.Basement.Prepare = function(bandit)
    local tasks = {}
...
ZombiePrograms.Basement.Main = function(bandit)
    local tasks = {}
