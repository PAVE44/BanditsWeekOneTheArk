...
BWOARooms.SecretLab.Prepare = function ()
    ...
    note2a:getModData().BWOA.onRead = {}
    note2a:getModData().BWOA.onRead.progressMissionId = 131
    ...
    note2b:getModData().BWOA.onRead = {}
    note2b:getModData().BWOA.onRead.progressMissionId = 131
    ...
    note2c:getModData().BWOA.onRead = {}
    note2c:getModData().BWOA.onRead.progressMissionId = 131
    ...
    note2d:getModData().BWOA = {}
    note2d:getModData().BWOA.onRead = {}
    note2d:getModData().BWOA.onRead.progressMissionId = 131
    ...
    note3:getModData().BWOA.onRead = {}
    note3:getModData().BWOA.onRead.progressMissionId = 131
    ...
    md.BWOA = {}
    md.BWOA.onRead = {}
    md.BWOA.onRead.progressMissionId = 131
    md.BWOA.onTaken = {}
