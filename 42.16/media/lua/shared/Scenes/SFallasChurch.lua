...
BWOAScenes.FallasChurch = BWOAScenes.Abstract:derive("BWOAScenes.FallasChurch")

function BWOAScenes.FallasChurch:placeObjects()
    local x, y, z = self.x, self.y, self.z
    local basement = BWOABasements.Generic:new(7383, 8347, 0, "wicked")
    --local basement = BWOABasements.Generic:new(7219, 8520, 0, "wicked")
...
function BWOAScenes.FallasChurch:placeItems()
    ...
    -- BWOAPrepareTools.AddWorldItemSpecial(7220, 8522, -1, note, {x=0.6, y=0.6, z=0.35})
